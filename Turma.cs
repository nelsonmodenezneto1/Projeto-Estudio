    ...
    internal class Turma
    {
        ...
        public bool cadastrarTurma()
        {
            ...
            try
            {
                ...
                MySqlCommand cadastrar = new MySqlCommand("insert into Estudio_Turma (id_modalidade, professor, dia_semana, hora) values(" + modalidade + ",'" + professor + "','" + dia_semana + "','" + hora + "')", DAO_Conexao.con);
        ...
        public bool excluirTurma()
        {
            ...
            {
                DAO_Conexao.con.Open();
                MySqlCommand deletar = new MySqlCommand("delete from Estudio_Turma where id_modalidade = " + modalidade + " and dia_semana = '" + dia_semana + "' and hora = '" + hora + "'", DAO_Conexao.con);
        ...
        public MySqlDataReader consultarTurma()
        {
            ...
            {
                DAO_Conexao.con.Open();
                MySqlCommand consulta = new MySqlCommand("select * from Estudio_Turma WHERE id_modalidade=" + modalidade + " group by dia_semana", DAO_Conexao.con);
                consultar = consulta.ExecuteReader();
            }
            catch (Exception ex)
            {
