...
namespace Estudio1
{
    class Aluno
    {
        ...
        public Aluno(string cPF, string nome, string rua, string numero, string complemento, string bairro, string cEP, string cidade, string estado, string telefone, string email)
        {
